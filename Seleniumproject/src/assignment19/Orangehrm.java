...
{   //path for chrome browser
	...
	//write First Name
	cdriver.findElement(By.name("firstName")).sendKeys("Pallavi");
	//write Middle Name
	cdriver.findElement(By.name("middleName")).sendKeys(" s ");
	//write Last name
	cdriver.findElement(By.name("lastName")).sendKeys("Wankhede");
	...
	//Write Employee Id
	cdriver.findElement(By.cssSelector("div.oxd-grid-2>div>div>div:nth-child(2)>input")).sendKeys("0284");
	//Save the details
	...
	cdriver.findElement(By.xpath("//div[@class='oxd-form-row']/div/div[2]//div/div[2]/input")).sendKeys("0284",Keys.ENTER);
	//click on search button
	cdriver.findElement(By.linkText("Search")).click();
	//click on Delete ID box
	//cdriver.findElement(By.cssSelector("div.oxd-table-body>div>div>div:nth-child(9)>div>button>i")).click();
	//click of select box
